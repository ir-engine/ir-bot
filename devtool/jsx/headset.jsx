			...
			<div className="card-body">
				<div className="row">
					<div className="col-4 d-flex justify-content-start align-items-center">
						<img src={assetURL + "/assets/images/headset.png"} className="control-icon" />
						<select
							id="vr-device-select"
					...
					<div className="col-8 d-flex justify-content-end align-items-center">
						<div className="control-button-group">
							...
							>
								<img src={assetURL + "/assets/images/stereo.png"} className="action-icon" />
								Stereo
							</button>
							<button
							...
							>
								<img src={assetURL + "/assets/images/exit.png"} className="action-icon" />
							</button>
							<button
								className={
									'btn headset-action-button' +
